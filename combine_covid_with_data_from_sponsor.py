...
with open('data/Covid_CA_2020_Weekly_stats.csv') as csv_file:
...
with open('data/redacted_full_stories_table.csv') as csv_file:
    csv_reader = csv.reader(csv_file, delimiter=',')
    line = 0
    for row in csv_reader:
        if line == 0: 
        ...
        information = [file_name, date, prison, tags, dict_of_comfired_case[prison], start_date, end_date]
